...
class _TeamsDetailState extends State<TeamsDetail> {
  ...
  TextEditingController regionControl = new TextEditingController();

  void updateProd(String tname, String region) async {
    DocumentReference dr = FirebaseFirestore.instance
        .collection("teams")
        .doc(widget.post.data()['team name']);

    Map<String, dynamic> entries = {"team name": tname, "Region": region};
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            title: Text("Modify/Delete " + widget.post.data()['team name']),
            actions: <Widget>[
              FlatButton(
                onPressed: (() {
        ...
        body: SingleChildScrollView(
          ...
          child: Column(children: <Widget>[
            ...
            RaisedButton(
                ...
                onPressed: () {
                  updateProd(tNameControl.text, regionControl.text);
                })
          ]),
        ));
  }
