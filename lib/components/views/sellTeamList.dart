...
import 'package:footiebank/components/views/viewPlayersSell.dart';

class SellTeamList extends StatefulWidget {
  final DocumentSnapshot post;
  SellTeamList({
    this.post,
  });
  @override
  _SellTeamListState createState() => _SellTeamListState();
}

class _SellTeamListState extends State<SellTeamList> {
  ...
  navigateToDetail(DocumentSnapshot post) {
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => ViewPlayersSell(
                  post: post,
                )));
  }
