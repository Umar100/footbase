...
import 'package:footiebank/components/details/teamDetail.dart';

class ViewPlayers extends StatefulWidget {
  @override
  _ViewPlayersState createState() => _ViewPlayersState();
}

class _ViewPlayersState extends State<ViewPlayers> {
